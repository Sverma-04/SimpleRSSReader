...
public class MainActivity extends AppCompatActivity {
    ...
    public static Button mFetchFeedButton;
    public static SwipeRefreshLayout mSwipeLayout;
    public static TextView mFeedTitleTextView;
    public static TextView mFeedLinkTextView;
    public static TextView mFeedDescriptionTextView;
